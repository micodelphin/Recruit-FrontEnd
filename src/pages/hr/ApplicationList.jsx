...
import { FaFileAlt, FaSearch, FaFileExport } from "react-icons/fa";
...
const ApplicationList = () => {
  ...
  const handleExport = () => {
    const data = filteredApplications.map((app, index) => ({
      ...
      Gender: app.gender,
      Combination: app.combination,
      School: app.schoolName,
      Status: app.status,
      NESAResult: app.nesaResult,
    ...
    XLSX.writeFile(
      workbook,
      `applications_${new Date().toLocaleDateString()}.xlsx`,
    );
  };
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-[#0f1117]">
      ...
      <div className="ml-64 flex-1 p-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6">
          Showing {APPLICATIONS_PER_PAGE} applications per page (A–Z sorted)
        </p>
        ...
        <div className="bg-white dark:bg-[#1a1d27] rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-white/10 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-1.5 rounded-lg bg-green-600 hover:bg-green-700 text-white text-xs font-medium transition"
            >
              <FaFileExport />
              Export Excel
            </button>
